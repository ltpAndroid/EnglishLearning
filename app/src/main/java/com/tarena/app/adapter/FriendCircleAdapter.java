...
public class FriendCircleAdapter extends MyAdapter<Message> {

    public FriendCircleAdapter(Context context, List<Message> data) {
        super(context, data);
    }
...
//       displayTextView(msg.getDetail(), holder.tv_content);
//       displayTextView(msg.getTitle(), holder.tv_title);
        holder.tv_content.setText(msg.getDetail());

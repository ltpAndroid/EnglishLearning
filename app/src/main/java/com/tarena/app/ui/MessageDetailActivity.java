...
//                .commit();
    ...
    private void initHeaderView() {
        ...
        tv_title = messageView.findViewById(R.id.tv_title);
        tv_content = messageView.findViewById(R.id.tv_content);
        layout_images =  messageView.findViewById(R.id.imagesLayout);
